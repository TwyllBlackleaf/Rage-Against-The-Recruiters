...
INSERT INTO questions(question_category_fk,answers_fk,question_type,is_deal_breaker,question_text,question_base_score,sort_order) VALUES(9,2,'integer',0,'What is the approximate yearly bonus?',10.00,1);
...
INSERT INTO questions(question_category_fk,answers_fk,question_type,is_deal_breaker,question_text,question_base_score,sort_order) VALUES(8,3,'boolean',0,'Is there a retirement plan?',10.00,1);
...
INSERT INTO questions(question_category_fk,answers_fk,question_type,is_deal_breaker,question_text,question_base_score,sort_order) VALUES(8,4,'decimal',0,'What amount of employer matching funds for retirement?',10.00,1);
...
INSERT INTO questions(question_category_fk,answers_fk,question_type,is_deal_breaker,question_text,question_base_score,sort_order) VALUES(8,6,'boolean',1,'Do you provide medical insurance?',10.00,1);
...
INSERT INTO questions(question_category_fk,answers_fk,question_type,is_deal_breaker,question_text,question_base_score,sort_order) VALUES(8,8,'boolean',1,'Is family medical coverage available?',10.00,1);
...
INSERT INTO questions(question_category_fk,answers_fk,question_type,is_deal_breaker,question_text,question_base_score,sort_order) VALUES(6,10,'boolean',1,'Vision coverage provided?',5.50,1);
...
INSERT INTO questions(question_category_fk,answers_fk,question_type,is_deal_breaker,question_text,question_base_score,sort_order) VALUES(6,12,'boolean',0,'Dental coverage provided?',7.50,1);
...
INSERT INTO questions(question_category_fk,answers_fk,question_type,is_deal_breaker,question_text,question_base_score,sort_order) VALUES(7,14,'integer',1,'Paid vacation days per year?',10.00,1);
...
INSERT INTO questions(question_category_fk,answers_fk,question_type,is_deal_breaker,question_text,question_base_score,sort_order) VALUES(7,15,'integer',0,'Paid sick days per year?',10.00,1);
...
INSERT INTO questions(question_category_fk,answers_fk,question_type,is_deal_breaker,question_text,question_base_score,sort_order) VALUES(7,16,'integer',0,'Paid holiday/personal days per year?',10.00,1);
...
INSERT INTO questions(question_category_fk,answers_fk,question_type,is_deal_breaker,question_text,question_base_score,sort_order) VALUES(6,17,'boolean',0,'Is there life insurance provided?',7.50,1);
...
INSERT INTO questions(question_category_fk,answers_fk,question_type,is_deal_breaker,question_text,question_base_score,sort_order) VALUES(6,19,'boolean',0,'Is there spouse or partner life insurance available?',7.50,1);
...
INSERT INTO questions(question_category_fk,answers_fk,question_type,is_deal_breaker,question_text,question_base_score,sort_order) VALUES(4,22,'integer',1,'What percentage of time will travel be required?',10.00,1);
...
INSERT INTO questions(question_category_fk,answers_fk,question_type,is_deal_breaker,question_text,question_base_score,sort_order) VALUES(3,23,'boolean',0,'Does this position require a security clearance?',7.50,1);
...
INSERT INTO questions(question_category_fk,answers_fk,question_type,is_deal_breaker,question_text,question_base_score,sort_order) VALUES(3,25,'boolean',0,'Does your company sponser visa applicants?',7.50,1);